  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-sm border p-8">
        ...
        <h1 className="text-3xl font-bold text-[#3730A3] mb-2">Terms of Service</h1>
        <p className="text-gray-500 text-sm mb-8">Last updated: March 2026</p>

        <div className="space-y-8 text-gray-700 leading-relaxed">
          <section>
            <h2 className="text-xl font-semibold text-[#3730A3] mb-3">1. Introduction</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#3730A3] mb-3">2. Acceptance of Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#3730A3] mb-3">3. Account Registration</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#3730A3] mb-3">4. Data Processing</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#3730A3] mb-3">5. Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#3730A3] mb-3">6. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#3730A3] mb-3">7. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#3730A3] mb-3">8. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#3730A3] mb-3">9. Changes to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#3730A3] mb-3">10. Contact Information</h2>
            <p>
              If you have any questions about these Terms, please contact us at{" "}
              <a href="mailto:legal@contentintel.app" className="text-blue-600 hover:underline">
